...
def checkParkingSpace(imgProc):
    ...
    for pos in posList:
        ...
        cvzone.putTextRect(img, str(count), (x, y+height-2), scale=0.5, thickness=1, offset=0, colorR=color)
    cvzone.putTextRect(img, f'Free : {spaceCounter}/{len(posList)}', (30, 80), scale=1, thickness=2, offset=10, colorR=(0, 200, 0))
